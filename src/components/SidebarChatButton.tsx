  ...
  return (
    ...
    hover:bg-gray-500/10 ${active ? 'bg-gray-500/20' : 'bg-transparent'}`}>
      ...
      <div className="flex-1 text-sm overflow-x-hidden">
        {editing && 
          <input
            className="w-full bg-transparent text-sm outline-none border
            border-blue-500"
            value={titleInput}
      ...
      {active && !deleting && !editing &&
        <div className="flex">
          <div onClick={() => setEditing(true)} className="cursor-poiter mx-1 opacity-60 hover:opacity-100">
            <IconEdit3 width={16} height={16} />
          </div>

          <div onClick={() => setDeleting(true)} className="cursor-poiter mx-1 opacity-60 hover:opacity-100">
      ...
      {(deleting || editing) && 
        <div className="flex">
        <div onClick={handleConfirmButton} className="cursor-poiter mx-1 opacity-60 hover:opacity-100">
          <IconCheck width={16} height={16} />
        </div>

        <div onClick={handleCancelButton} className="cursor-poiter mx-1 opacity-60 hover:opacity-100">
